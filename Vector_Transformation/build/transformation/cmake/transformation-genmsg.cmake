...
message(STATUS "transformation: 2 messages, 0 services")

set(MSG_I_FLAGS "-Itransformation:/home/yididya/Vector_Transformation/src/transformation/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/yididya/Vector_Transformation/src/transformation/msg/Input.msg" NAME_WE)
add_custom_target(_transformation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "transformation" "/home/yididya/Vector_Transformation/src/transformation/msg/Input.msg" ""
)

get_filename_component(_filename "/home/yididya/Vector_Transformation/src/transformation/msg/Output.msg" NAME_WE)
add_custom_target(_transformation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "transformation" "/home/yididya/Vector_Transformation/src/transformation/msg/Output.msg" ""
)
...
_generate_msg_cpp(transformation
  "/home/yididya/Vector_Transformation/src/transformation/msg/Input.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/transformation
)
_generate_msg_cpp(transformation
  "/home/yididya/Vector_Transformation/src/transformation/msg/Output.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/transformation
)
