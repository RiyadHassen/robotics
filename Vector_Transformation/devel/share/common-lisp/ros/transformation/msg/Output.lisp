...
(cl:defmethod cl:initialize-instance :after ((m <Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name transformation-msg:<Output> is deprecated: use transformation-msg:Output instead.")))
