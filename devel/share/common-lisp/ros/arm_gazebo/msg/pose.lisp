...
(cl:defmethod cl:initialize-instance :after ((m <pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_gazebo-msg:<pose> is deprecated: use arm_gazebo-msg:pose instead.")))
...
(cl:defmethod option-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_gazebo-msg:option-val is deprecated.  Use arm_gazebo-msg:option instead.")
  (option m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<pose>)))
  ...
  "90439c567650737834064a6bf6be0f59")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'pose)))
  "Returns md5sum for a message object of type 'pose"
  "90439c567650737834064a6bf6be0f59")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<pose>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%int64 option~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'pose)))
  "Returns full string definition for message of type 'pose"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%int64 option~%~%"))
